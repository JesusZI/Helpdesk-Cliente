  <div data-bs-spy="scroll" class="scrollspy-example">
      ...
      <section id="hero-animation">
        <div id="landingHero" class="section-py landing-hero position-relative">
          <img
            src="vistas/assets/img/front-pages/backgrounds/hero-bg.png"
            alt="hero background"
          ...
          <div class="container">
            <div class="hero-text-box text-center position-relative">
              ...
              <h2 class="text-primary display-6 fw-extrabold">
               Un Sistema de Mesa de Ayuda para la Gestión de Tickets
              </h2>
              ...
              <div class="landing-hero-btn d-inline-block position-relative">
                <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium"
                  >Tienes Problemas?
                  <img
                    src="vistas/assets/img/front-pages/icons/Join-community-arrow.png"
                    alt="Join community arrow"
                    class="scaleX-n1-rtl"
                /></span>
                <a href="contactenos" class="btn btn-primary btn-lg">¡Contactanos!</a>
              </div>
            </div>
            <div id="heroDashboardAnimation" class="hero-animation-img">
              <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                  <img
                    src="vistas/assets/img/front-pages/landing-page/hero-dashboard-light.png"
                    alt="hero dashboard"
                    class="animation-img"
                    data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                    data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
                  <img
                    src="vistas/assets/img/front-pages/landing-page/hero-elements-light.png"
                    alt="hero elements"
      ...
      <section id="landingFeatures" class="section-py landing-features">
        <div class="container">
          ...
          <h4 class="text-center mb-1">
            ...
            para gestionar tu mesa de ayuda
          </h4>
          <p class="text-center mb-12">
            Un sistema completo para la gestión eficiente de tickets y soporte a usuarios.
          </p>
          <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-2">Gestión de Tickets</h5>
              <p class="features-icon-description">
                Crea, asigna y da seguimiento a tickets de soporte de manera sencilla y centralizada.
              </p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="mb-4 text-primary text-center">
              ...
              <h5 class="mb-2">Base de Conocimientos</h5>
              <p class="features-icon-description">
                Acceso rápido a artículos, preguntas frecuentes y soluciones para resolver incidencias comunes.
              </p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-2">Notificaciones y Alertas</h5>
              <p class="features-icon-description">
                Recibe avisos automáticos sobre nuevos tickets, respuestas y cambios de estado.
              </p>
            </div>
            <div class="col-lg-6 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-2">Reportes y Estadísticas</h5>
              <p class="features-icon-description">
                Visualiza métricas clave sobre tiempos de respuesta, satisfacción y desempeño del equipo.
              </p>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-2">Fácil de Usar</h5>
              <p class="features-icon-description">
                Interfaz intuitiva para agentes y usuarios, sin necesidad de capacitación avanzada.
              </p>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center gx-0 gy-4 g-lg-5 mb-5 pb-md-5">
            <div class="col-md-6 col-lg-5 col-xl-3">
              ...
              Descubre lo que nuestros clientes<br class="d-none d-xl-block" />
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “SoluDesk ha transformado nuestro servicio de soporte. La gestión de tickets es mucho más ágil y transparente para todo el equipo.”
                          </p>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-3 avatar-sm">
                              <img src="vistas/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Cecilia Payne</h6>
                              <p class="small text-body-secondary mb-0">Gerente de TI</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “La interfaz de SoluDesk es tan intuitiva que nuestro equipo no requirió capacitación adicional. Ahora resolvemos incidencias en la mitad de tiempo.”
                          </p>
                          <div class="text-warning mb-4">
                            <i class="icon-base bx bxs-star"></i>
                            <i class="icon-base bx bxs-star"></i>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-3 avatar-sm">
                              <img src="vistas/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Eugenia Moore</h6>
                              <p class="small text-body-secondary mb-0">Coordinadora de Soporte</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “Gracias a la base de conocimientos de SoluDesk, nuestros usuarios encuentran soluciones por sí mismos y liberan al equipo de soporte para casos más complejos.”
                          </p>
                          <div class="text-warning mb-4">
                            <i class="icon-base bx bxs-star"></i>
                            <i class="icon-base bx bxs-star"></i>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-3 avatar-sm">
                              <img src="vistas/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Curtis Fletcher</h6>
                              <p class="small text-body-secondary mb-0">Director de Conocimiento</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “Las notificaciones y alertas de SoluDesk mantienen a todo el equipo informado al instante. Nunca más perdemos un ticket urgente.”
                          </p>
                          <div class="text-warning mb-4">
                            <i class="icon-base bx bxs-star"></i>
                            <i class="icon-base bx bxs-star"></i>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-3 avatar-sm">
                              <img src="vistas/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Sara Smith</h6>
                              <p class="small text-body-secondary mb-0">Jefa de Operaciones</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “Los reportes y estadísticas detalladas de SoluDesk nos permiten medir nuestro rendimiento y mejorar continuamente nuestros tiempos de respuesta.”
                          </p>
                          <div class="text-warning mb-4">
                            <i class="icon-base bx bxs-star"></i>
                            <i class="icon-base bx bxs-star"></i>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-3 avatar-sm">
                              <img src="vistas/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Miguel Hernández</h6>
                              <p class="small text-body-secondary mb-0">Analista de Métricas</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <p>
                            “Excelente atención al cliente y soporte continuo. SoluDesk es la solución perfecta para gestionar el help desk de nuestra empresa.”
                          </p>
                          <div class="text-warning mb-4">
                            <i class="icon-base bx bxs-star"></i>
                            <i class="icon-base bx bxs-star"></i>
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div>
                              <h6 class="mb-0">Laura Gómez</h6>
                              <p class="small text-body-secondary mb-0">Coordinadora de Atención</p>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <section id="landingTeam" class="section-py landing-team">
        <div class="container">
          <div class="text-center mb-4">
            <span class="badge bg-label-primary">Equipo de Soporte SoluDesk</span>
          </div>
          <h4 class="text-center mb-1">
            <span class="position-relative fw-extrabold z-1">
              Conoce a&nbsp;
          ...
          <p class="text-center mb-md-11 pb-0 pb-xl-12">
            Los profesionales que mantienen tu sistema de mesa de ayuda siempre en marcha.
          </p>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-primary border border-bottom-0 border-primary-subtle position-relative team-image-box">
                  <img
                    src="vistas/assets/img/front-pages/landing-page/team-member-1.png"
                ...
                <div class="card-body border border-top-0 border-primary-subtle text-center py-5">
                  ...
                  <p class="text-body-secondary mb-0">Gerente de Soporte</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-info border border-bottom-0 border-info-subtle position-relative team-image-box">
                  <img
                    src="vistas/assets/img/front-pages/landing-page/team-member-2.png"
                    class="position-absolute card-img-position bottom-0 start-50"
                    alt="Paul Miles" />
                </div>
                <div class="card-body border border-top-0 border-info-subtle text-center py-5">
                  <h5 class="card-title mb-0">Paul Miles</h5>
                  <p class="text-body-secondary mb-0">Especialista de Base de Conocimientos</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-danger border border-bottom-0 border-danger-subtle position-relative team-image-box">
                  <img
                    src="vistas/assets/img/front-pages/landing-page/team-member-3.png"
                    class="position-absolute card-img-position bottom-0 start-50"
                    alt="Nannie Ford" />
                </div>
                <div class="card-body border border-top-0 border-danger-subtle text-center py-5">
                  <h5 class="card-title mb-0">Nannie Ford</h5>
                  <p class="text-body-secondary mb-0">Coordinadora de Tickets</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-success border border-bottom-0 border-success-subtle position-relative team-image-box">
                  <img
                    src="vistas/assets/img/front-pages/landing-page/team-member-4.png"
                    class="position-absolute card-img-position bottom-0 start-50"
                    alt="Chris Watkins" />
                </div>
                <div class="card-body border border-top-0 border-success-subtle text-center py-5">
                  <h5 class="card-title mb-0">Chris Watkins</h5>
                  <p class="text-body-secondary mb-0">Analista de Alertas</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- CTA: Start -->
      <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
        <img
          src="vistas/assets/img/front-pages/backgrounds/cta-bg-light.png"
        ...
        <div class="container">
          <div class="row align-items-center gy-12">
            <div class="col-lg-6 text-start text-sm-center text-lg-start">
              <h3 class="cta-title text-primary fw-bold mb-1">¿Tienes Problemas?</h3>
              <p class="cta-description mb-4">
                Nuestro equipo de soporte está aquí para ayudarte. No dudes en contactarnos para cualquier consulta o asistencia que necesites.
              </p>
            <a href="index.php?ruta=contactenos" class="btn btn-lg btn-primary">¡Contactanos!</a>
            </div>
            <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
              <img
                src="vistas/assets/img/front-pages/landing-page/cta-dashboard.png"
                alt="cta dashboard"
              ...
              <div class="card border border-primary shadow-none">
                <div class="card-body text-center">
                  <div class="mb-4 text-primary">
                    <!-- keep original support tickets icon -->
                    <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path opacity="0.2" d="M10 44.4663V18.4663C10 17.4054 10.4214 16.388 11.1716 15.6379C11.9217 14.8877 12.9391 14.4663 14 14.4663H50C51.0609 14.4663 52.0783 14.8877 52.8284 15.6379C53.5786 16.388 54 17.4054 54 18.4663V44.4663H10Z" fill="currentColor"/>
                      <path d="M10 44.4663V18.4663C10 17.4054 10.4214 16.388 11.1716 15.6379C11.9217 14.8877 12.9391 14.4663 14 14.4663H50C51.0609 14.4663 52.0783 14.8877 52.8284 15.6379C53.5786 16.388 54 17.4054 54 18.4663V44.4663M36 22.4663H28M6 44.4663H58V48.4663C58 49.5272 57.5786 50.5446 56.8284 51.2947C56.0783 52.0449 55.0609 52.4663 54 52.4663H10C8.93913 52.4663 7.92172 52.0449 7.17157 51.2947C6.42143 50.5446 6 49.5272 6 48.4663V44.4663Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </div>
                  <h3 class="mb-0">12.3k+</h3>
                  <p class="fw-medium mb-0">
                    Tickets Resueltos<br />
                    en SoluDesk
                  </p>
                </div>
              </div>
          ...
          <div class="row gy-12 align-items-center">
            <div class="col-lg-5">
              <div class="text-center">
                <img
                  src="vistas/assets/img/front-pages/landing-page/faq-boy-with-logos.png"
            ...
            <div class="col-lg-7">
              <div class="accordion" id="accordionExample">
                ...
                $sql = "SELECT id, pregunta, respuesta FROM faqs LIMIT 5";
                ...
                if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    ...
                    <div class="card accordion-item">
                      ...
                      <div id="accordion'.$i.'" class="accordion-collapse collapse '.$show.'" aria-labelledby="heading'.$i.'" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                          '.htmlspecialchars($row["respuesta"]).'
                        </div>
                      </div>
                    </div>
                    ';
                  ...
                  echo '<p>No hay preguntas frecuentes registradas.</p>';
                }
                $conn->close();
                ?>
              </div>
